...
"""
Created on Mon Oct 13 14:02:41 2020
...
short_research_dag = DAG('short_research_dag', default_args=default_args, schedule_interval= '0 20 * * *')

reddit_WSB_sh = BashOperator(
    task_id='short_research_fetch',
    bash_command="python3 /home/ec2-user/Short_research/short_research_fetch.py ",
    queue="pipeline2",
    dag=short_research_dag)
